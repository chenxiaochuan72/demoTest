...
//设置安全证书
    ...
    public static void main(String[] args) {
        ...
        complaint.setInsuranceType("车险");
        complaint.setName("陈晓川");
        complaint.setGender("男");
        complaint.setContactNumber("18341057178");
        complaint.setLocation("北京");
        complaint.setPolicyNumber("P15000000000");
        complaint.setMessage("陈晓川是中科软最帅的");
        complaint.setApplicantName("周鑫");
        extracted(complaint);
		/*
		try {
			sendEmail.send();
    ...
    private static void extracted(Complaint complaint) {
